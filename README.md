...
Our team 👥 was inspired by HackMerced VII's theme *Light the Future* and track *Open Innovation* to create LYF. We wanted to provide an interactive way to show the different time periods human beings have gone through to get to the present 🕰️. By showcasing different obstacles each era faced, we were able to show a bit of history in our game. 
...
We also hope to incorporate a character selection portion to our game to allow players of all shapes and sizes to be represented in our game.
...
- **HTML/CSS and Javascript** - Our team used these tools to build and style our website that hosts the Unity WebPlayer. HTML/CSS was used to style each page, and Javascript was used to make our landing page interactive. 
...
- 😎 **Ethan Machado** - “Hello! I’m a third year student at California State University, Stanislaus double majoring in computer science and economics with a concentration in cybersecurity. I am interested in software engineering, data science, and cybersecurity. I helped create our website, our game character, and several game backgrounds. Fun Fact: I enojy playing Tennis."

- ⭐ **David Lima** - “Hey there! I am David Lima from Stanislaus State located in California, currently majoring in Computer Science. I have an interest in software development, video games, and I enjoy playing sports in my free time. In this project I was in charge of creating the C# script in Unity."

- 🏀 **Moon Kai Lye** - “Hi! I'm a student of John Jay College of Criminal Justice. I'm majoring computer science and information technology. I am interested in cybersecurity, art and machine learning. In this project, I am responsible to create some backgrounds using pixel art for my team. Fun Fact: When I have a free time, I like to play basketball and some video games."
